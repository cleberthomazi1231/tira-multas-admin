  ...
  return (
    <Flex width="100%" flexDirection="column">
      ...
      >
        ...
        <Card title="Revendedores Inativos" value={'0'} color="blue.500" />
        <Card
          ...
          {dealers.map(dealer => (
            <Flex key={dealer.id} width="100%" py="8px">
              ...
              <Flex
                ...
                cursor="pointer"
                borderRadius="50%"
                onClick={() => navigate(`/revendedores/atualizar/${dealer.id}`)}
              >
                <Icon as={FiEdit} fontSize="18px" color="yellow.500" />
              </Flex>
            </Flex>
          ))}
        </Flex>
              ...
              <Flex width="100%" flexDirection="column" fontSize="14px">
                {orders.map(item => (
                  <Flex key={item} width="100%" py="8px">
                    <Text width="100%" maxWidth="100%">{`${String(item.id)
                      .substring(0, 8)
                      .toUpperCase()}`}</Text>
                    ...
                    <Flex width="100%" maxWidth="120px">
                      <Stack direction="row" justifyItems="center">
                        ...
                        <Flex
                          ...
                          borderRadius="50%"
                          onClick={() =>
                            navigate(`/vendas/${item.id}/visualizar`)
                          }
                        >
                          <Icon as={FiEye} fontSize="18px" color="black" />
                        </Flex>
                      </Stack>
                    </Flex>
                  </Flex>
