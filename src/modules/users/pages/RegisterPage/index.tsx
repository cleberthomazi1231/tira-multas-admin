  ...
  const handleSubmit = useCallback(() => {
    try {
      ...
      const schema = z.object({
        ...
        telephone: z.string().min(1, { message: 'Telefone obrigatório' }),
      ...
      apiBackend
        .post('/users', {
          ...data,
          permissions: permissions.includes('Admin') ? 'Admin' : 'Default'
        })
        .then(response => {
            ...
            <Flex width={['100%', '100%', '48%']} flexDirection="column">
              ...
              >
                ...
                <Flex width="100%" fontWeight="400" gap="16px">
                  <Checkbox
                    name="p1"
                    onChange={() => handleChangePermissions('Admin')}
                    isChecked={permissions.includes('Admin')}
                    colorScheme="green"
                  >
                    <Text fontSize="14px">Admnistrador</Text>
                  </Checkbox>
                  <Checkbox
                    name="p2"
                    onChange={() => handleChangePermissions('Default')}
                    isChecked={permissions.includes('Default')}
                    colorScheme="green"
                  >
                    <Text fontSize="14px">Apenas Visualizar</Text>
                  </Checkbox>
                </Flex>
              </Flex>
            </Flex>
