  ...
  const handleSubmit = useCallback(() => {
    try {
      ...
      const schema = z.object({
        ...
        document: z.string().min(1, { message: 'CPF/CNPJ obrigatório' }),
      ...
      {dealer && (
        <Flex width="100%" flexDirection="column">
          ...
          >
            ...
            >
              <Flex width={['100%', '100%', '48%']} flexDirection="row">
                <Flex
                  width="100%"
                  justifyContent="space-between"
                  flexDirection={'column'}
                >
                  ...
                  <Flex width={'100%'} flexDirection="column">
                    <Input
                      name="complement"
                      label="Complemento"
                      defaultValue={dealer?.address.complement}
                    />
                  </Flex>
                ...
                >
                  ...
                  <Flex width={'100%'} flexDirection="column">
                    <Input
                      ...
                      defaultValue={dealer?.address.zipcode}
                    />
                  </Flex>
                  ...
                  <Flex width={'100%'} flexDirection="column">
                    <Input
                      name="number"
                      label="Nº"
                      defaultValue={dealer?.address.number}
                    />
                  </Flex>
                  ...
                  <Flex width={'100%'} flexDirection="column">
                    <Input
                      name="neighborhood"
                      label="Bairro"
                      defaultValue={dealer?.address.neighborhood}
                    />
                  </Flex>
