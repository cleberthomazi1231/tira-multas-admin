...
export default function ModalEditFlag({ flag, onChange, isOpen, onClose }) {
  ...
  const handleAddField = useCallback(() => {
    const dataOptions = options.map((option, index) => {
      return {
        value: formRef?.current?.getFieldValue(`field_option[${index}]`) || '',
        anexo:
          formRef?.current?.getFieldValue(`field_option_anexo[${index}]`) || '',
                        ...
                        <Flex width="100%" flexDirection="column">
                          ...
                          <Flex width="100%" gap="8px">
                            <InputRadio
                              ...
                              value="PARAGRAPH"
                              checked={option.relation === 'PARAGRAPH'}
                              onChange={e =>
                            ...
                            <InputRadio
                              ...
                              name={`field_option_relation[${index}]`}
                              value="OPEN_FIELD"
                              checked={option.relation === 'OPEN_FIELD'}
                              onChange={e =>
                                handleChangeRelation(
                                  e.currentTarget.value,
                                  index
